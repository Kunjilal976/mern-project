    ...
    <div className='flex flex-col gap-6 p-20 px-3 max-w-6xl mx-auto '>
      <h1 className='text-slate-200 font-bold text-3xl lg:text-6xl'>
        Find your next <span className='text-slate-200'>perfect </span>
         ...
         place with roomieRent
      </h1>
      <div className='text-gray-400 text-xs sm:text-xl'>
        RommieRent is the best place to find your next perfect place to
        live.
        <br />
      ...
      {offerListings && offerListings.length > 0 && (
        <div className=''>
          <div className='my-3'>
            ...
            <Link className='text-sm font-bold text-blue-600 hover:underline' to={'/search?offer=true'}>Show more offers</Link>
          </div>
      ...
      {rentListings && rentListings.length > 0 && (
        <div className=''>
          <div className='my-3'>
            ...
            <Link className='text-sm font-bold text-blue-600 hover:underline' to={'/search?type=rent'}>Show more places for rent</Link>
          </div>
          <div className='flex flex-wrap gap-4'>
      ...
      {saleListings && saleListings.length > 0 && (
        <div className=''>
          <div className='my-3'>
            ...
            <Link className='text-sm text-blue-600 font-bold hover:underline' to={'/search?type=sale'}>Show more places for sale</Link>
          </div>
          <div className='flex flex-wrap gap-4'>
